/**
 * GET /api/admin/equity — Equity dashboard data for a tenant. Platform admin only.
 * Query: tenantId (required). Returns completion rates by demographics and equity metric counts.
 */
...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error("Equity dashboard error:", e);
