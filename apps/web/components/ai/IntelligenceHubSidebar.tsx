...
/**
 * Reusable floating help + global chat trigger for dashboard pages.
 * Renders a floating AI button that opens the Intelligence Hub or a slide-over chat.
 */
...
type IntelligenceHubSidebarProps = {
  /** When true, hide the floating button (e.g. when aiEnabled is false). */
  hidden?: boolean;
      ...
      <>
        ...
        {slideOpen && (
          <div className="fixed inset-0 z-[100] flex justify-end">
            <div className="absolute inset-0 bg-black/50" onClick={() => setSlideOpen(false)} aria-hidden />
            <div className="relative w-full max-w-md bg-space-950 border-l border-white/10 shadow-xl flex flex-col">
